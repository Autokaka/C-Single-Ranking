...
void LibraryCard::regist()
{
	...
	if (out.is_open())
	{
		out << left << setw(20) << ++Number << setw(20) << Name << setw(20) << Password << setw(20) << 1 << endl;
		out.close();
	}
...
void LibraryCard::printID()
{
	...
	cout << left << setw(20) << "读者编号" << setw(20) << "姓名" << setw(20) << "密码" << setw(20) << "借阅等级" << setw(20) << "借书编号" << endl;
	string Client;
